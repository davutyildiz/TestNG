...
public class HW extends CommonMethods {
	...
	public Object[][] getData() {
		Object[][] data = { { "James", "Smithh", "james007", "Arlington@2@20"},
				{ "John", "Brownn", "john007", "Arlington@2@19"},
				{ "Ramesh", "Yadavv", "ram007", "NewYear@2@20"},
				{ "Mukesh", "Sharmaa", "mukesh007", "Syntax@2@20"},
				{ "Raj", "Maharjann", "raj007", "Fairfax@2@20"} };
		return data;
	}
}
